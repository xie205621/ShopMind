...
> **Generated:** 2026-07-24 16:33:17 CST | **Elapsed:** 24,444ms
...
| Task Success Rate | **52.4%** (66/126) | Success |
| Avg TTFT | **356 ms** | Performance |
| P95 Latency | **1247 ms** | Performance |
...
| TOOL-003 | 先查一下我的订单状态，然后如果可以的话帮我退款 | 工具参数错误 | 正在使用queryOrder工具查询您的订单... 当前所有订单均已完成。如需退款，请提供具体订单号，我将使用refun... |
| TOOL-006 | 我的会员积分有多少？ | 意图识别错误 | 正在使用queryPoints工具查询您的会员积分... 当前积分：1250分，会员等级：金卡。再消费750元即可升级为... |
...
---
*Report generated by ShopMind Evaluation Engine v2.0 — 2026-07-24 16:33:17*
